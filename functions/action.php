...
class action extends library{
    ...
    public function list_product_bycat ($arr_product, $trang, $page, $lm) {
        $limit = $lm;
    ...
    public function list_product_bycat_xd ($arr_product, $trang, $page, $lm) {
        $limit = $lm;
        ...
        $p = $this->paging_xd($total, $trang, $limit, $page, $page);
        $return = array(
            'data' => $product1,
            'paging' => $p
        );
    ...
    public function paging_xd ($total_record, $trang, $limit, $page, $slug = '') {
        // $slug = '';
        $config = array(
            ...
            'link_full'=> $slug != '' ? '/'.$slug.'/{trang}/'.$_GET['search'] : 'index.php?page='.$page.'&trang={trang}',

            'link_first'=> $slug != '' ? '/'.$slug.'/1/'.$_GET['search'] : 'index.php?page='.$page,
    ...
    public function list_product_paging_pc ($arr_product, $pc, $trang, $limit = 20) {
        // $limit = 20;
