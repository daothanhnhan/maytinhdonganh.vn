...
if(@$_POST['nlpayment']) {
	...
	// $array_items=array();				
	// $total_amount= 3000; 
	$code_sale = $action->getList('code_sale', '', '', 'id', 'asc', '', '', '');
	$code = $_POST['sale'];
    $money = 0;
    $percent = 0;
    if (!empty($code)) {
      foreach ($code_sale as $item) {
        if ($item['code']==$code) {
    ...
    if ($money != 0) {
    	...
    	$total_amount = $total_amount - $total_amount*$percent/100;
    }
	...
	////////////////////
	 ...
	 $buyer_fullname =$_POST['txtName'];
	 $buyer_email =$_POST['txtEmail'];
	 $buyer_mobile =$_POST['txtPhone'];
	 
	 $buyer_address = $_POST['txtAddress'];
...
<div class="gb-chonphuongthucthanhtoan">
    ...
    <form  name="NLpayBank" action="#" method="post" id="nganluong">
        ...
        <div class="form-group">
            <label>Họ Tên:	</label>
            <input type="text" id="fullname" name="txtName" class="field-check  form-control" value="" required>
        </div>
        <div class="form-group">
            <label>Email:	</label>
            <input type="email" id="fullname" name="txtEmail" class="field-check  form-control" value="" required>
        </div>
        <div class="form-group">
            <label for="">Số Điện thoại:	</label>
            <input type="text"  id="fullname" name="txtPhone" class="field-check form-control" value="" required>
        </div>
        <div class="form-group">
            <label for="">Địa chỉ:	</label>
            <input type="text"  id="fullname" name="txtAddress" class="field-check form-control" value="" >
        </div>
        <div class="form-group">
            <label for="">Ghi chú:	</label>
            
            <textarea name="txtNote" class="field-check form-control" rows="5" style="height: 100px;"></textarea>
        </div>
        <div class="form-group">
            <label for="">Nhập mã khuyến mãi:	</label>
            <input type="text"  id="fullname" name="sale" class="field-check form-control" value="" onkeyup="price_sale(this)" onchange="price_sale(this)" >
        </div>
        <ul class="list-content">
            <li class="active">
                <label><input type="radio" value="NL" name="option_payment" selected="true" required="">Thanh toán bằng Ví điện tử NgânLượng</label>
