...
class library{
	...
	/*------------- Hàm select list ----------------*/
	    ...
	    public function getList_search($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        $list_id = $this->getProductCat_byProductCatIdParentHighest_lib($_GET['cat'], 'desc');//var_dump($list_id);
	        $key = $_GET['key'];
	        $where = "WHERE product_name like '%$key%'";

	        $cat = $_GET['cat'];
	        if ($cat != 0) {
	        	$where .= " AND (productcat_ar like '%$cat%'";
	    ...
	    public function getList_xaydung($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        if (!empty($_SESSION['attribute_xd'])) {
		        $where .= " AND (1=0";
	        ...
	        if (!isset($_SESSION['sort_price_xd'])) {
		        $sort = 'default';
		    } else {
		        $sort = $_SESSION['sort_price_xd'];
		    }
	        ...
	        if ($trang != "" && $limit != "") {
	            ...
	            $config = array(
	                ...
	                'link_full'=> $slug != '' ? '/'.$slug.'/{trang}/'.$_GET['search'] : 'index.php?page='.$page.$cond.'&trang={trang}',

	                'link_first'=> $slug != '' ? '/'.$slug.'/{trang}/'.$_GET['search'] : 'index.php?page='.$page,
	    ...
	    public function getList_xaydung_all($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	    ...
	    public function getList_pc($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        $where = " Where xay_dung_id = $id_Cat";
...
//            $results = $stmt->get_result();
	...
	/*-------------- Hàm tìm kiếm admin ---------------*/
	    ...
	    public function getSearchAdmin_baohanh($table, $name_search, $value_search, $trang, $limit, $page){
...
public function getProductCat_byProductCatIdParentHighest_lib($idProductCatParent,$order_productCatId){
    ...
    $list = $this->getProductCat_byProductCatIdParent_lib($idProductCatParent,$order_productCatId);
    ...
    foreach ($list as $key => $value) {
        ...
        $this->getProductCat_byProductCatIdParentHighest_lib($value[$nameColIdProduct],$order_productCatId);
...
public function getProductCat_byProductCatIdParent_lib($idProductCatParent,$order_productCatId){
