        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ///////////// thuong hoi //////////////
                    case "thuong-hoi":
                        include_once("template/thuong-hoi/thuong-hoi.php");
                        break;
                    case "them-thuong-hoi":
                        include_once("template/thuong-hoi/them-thuong-hoi.php");
                        break;
                    case "sua-thuong-hoi":
                        include_once("template/thuong-hoi/sua-thuong-hoi.php");
                        break;
                    case "xoa-thuong-hoi":
                        include_once("template/thuong-hoi/xoa-thuong-hoi.php");
                        break;
                    //////////// ma khuyen mai ////////////
                    case "ma-khuyen-mai":
                    ...
                    case "bao-hanh":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-don-hang.css' />";
                        include_once("template/don-hang/bao-hanh.php");
                        break;
                    case "them-bao-hanh":
                    ...
                    ////////////// mua tra gop ////////////
                    case "mua-tra-gop":
                        include_once("template/mua-tra-gop/mua-tra-gop.php");
                        break;
                    case "xoa-mua-tra-gop":
                        include_once("template/mua-tra-gop/xoa-mua-tra-gop.php");
                        break;
                    /////////////// import ////////////////
                    case "import":
                        include_once("template/import/index.php");
                        break;
                    case "import-code-sale":
                        include_once("template/import/codesale.php");
                        break;
                    /////////////// xoa all san phẩm //////
                    case "xoa-all-san-pham":
                        include_once("template/san-pham/xoa-all-san-pham.php");
                        break;
                    case "xoa-all-ma-khuyen-mai":
                        include_once("template/ma-khuyen-mai/xoa-all-ma-khuyen-mai.php");
                        break;
                    /////////////// nhận tin //////////////
                    // case "nhan-tin":
