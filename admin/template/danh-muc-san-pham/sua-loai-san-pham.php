...
<form action="" method="post" accept-charset="utf-8" id="updateProductCat">
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="titleRightNCP">Chọn ảnh (Kích thước: 350x350)</p>
            <div id="wrapper">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="number" class="txtNCP1"  name="productcat_sort_order" value="<?php echo $row['productcat_sort_order']?>"/>
        </div>
    </div><!--end rowNodeContentPage-->
