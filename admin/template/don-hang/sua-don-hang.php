                ...
                <div class="contentPage">
                    <div class="box1">
                        ...
                        <div class="infor-order">
                            ...
                            <?php if ($rowOrder['discount'] != 0 || $rowOrder['percent'] != 0) { ?>
                            <span>Giá khuyến mãi: </span>
                                <?php if ($rowOrder['discount'] != 0) { ?>
                            <span class="price"><?php echo number_format($totalprice-$rowOrder['discount'], "0","",".");?> đ</span>
                                <?php } else { ?>
                            <span class="price"><?php echo number_format($totalprice-($totalprice*$rowOrder['percent'])/100, "0","",".");?> đ</span>
                                <?php } ?>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="box2">
                        ...
                        <input type="hidden" name="sale_state" value="<?= $rowOrder['sale_state'] ?>">
                        <input type="hidden" name="code_sale" value="<?= $rowOrder['code_sale'] ?>">
                    </div>
