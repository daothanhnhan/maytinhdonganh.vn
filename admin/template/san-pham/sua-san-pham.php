    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
           ...
           <!--  <p class="titleRightNCP">Danh mục</p>
            ...
            <p class="titleRightNCP">Link drive google:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP2 ckeditor1" id="editor0" name="product_img_1"><?php echo $row['product_img_1'];?></textarea></p>
            ...
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1" name="product_content"><?php echo $row_showMain['lang_product_content'];?></textarea></p>

            <p class="titleRightNCP">Video:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor2" name="product_sub_info1"><?php echo $row_showMain['lang_product_sub_info1'];?></textarea></p>

            <p class="titleRightNCP">Giới thiệu sản phẩm:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor3" name="product_sub_info2"><?php echo $row_showMain['lang_product_sub_info2'];?></textarea></p>

            <p class="titleRightNCP">Thông tin khuyến mại:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor4" name="product_sub_info3"><?php echo $row_showMain['lang_product_sub_info3'];?></textarea></p>
        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <select name="xay_dung_id" class="txtNCP1">
                        <option value="0">==Chọn xây dựng máy tính==</option>
                        <?php foreach ($xay_dung as $item) { ?>
                        <option value="<?= $item['id'] ?>" <?= $item['id']==$row['xay_dung_id'] ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                        <?php } ?>
                    </select>
        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <p class="titleRightNCP">Giá không lấy quà (VNĐ)</p>

                    <input type="number" class="txtNCP1" value="<?php echo $row['product_price_1'];?>" name="product_price_1"/>

                </div>                                      

                <div class="subColContent" >

                    <p class="titleRightNCP">Giá sốc (VNĐ)</p>

                    <input type="number" class="txtNCP1" value="<?php echo $row['product_price_2'];?>" name="product_price_2"/>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent" >
                    ...
                    <select name="product_stock" class="txtNCP1">
                        <option value="0" <?= $row['product_stock']==0 ? 'selected' : '' ?> >Hết hàng</option>
                        <option value="1" <?= $row['product_stock']==1 ? 'selected' : '' ?> >Còn hàng</option>
                    </select>
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="clear_stock" <?= $row['clear_stock'] == 1 ? 'checked' : '' ?>>Sản phẩm Clear Stock
