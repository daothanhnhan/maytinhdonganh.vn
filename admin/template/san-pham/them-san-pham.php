...
<form action="" method="post" enctype="multipart/form-data" id="addProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1" name="product_content"><?php echo $rowPro['product_content'];?></textarea></p>
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="clear_stock" <?= $rowPro['clear_stock'] == 1 ? 'product_hot' : '' ?>>Sản phẩm Clear Stock
