...
// echo json_encode(array('error'=>'Lỗi, mời thử lại'));die;
	...
	/*--------------- Danh mục sản phẩm -------------------*/
		...
		public function deleteProductCat(){
			...
			if ($productcat_id == 423 || $productcat_id == 500) {
	...
	/*--------------- Sản phẩm --------------------*/
		...
		public function addProduct(){
			...
			$xay_dung_id = isset($_POST['xay_dung_id']) ? $_POST['xay_dung_id'] : '';

			$product_stock = isset($_POST['product_stock']) ? $_POST['product_stock'] : '0';

			$product_price_1 = isset($_POST['product_price_1']) ? $_POST['product_price_1'] : '0';

			$product_price_2 = isset($_POST['product_price_2']) ? $_POST['product_price_2'] : '0';

			$product_img_1 = isset($_POST['product_img_1']) ? $_POST['product_img_1'] : '';

			$clear_stock = isset($_POST['clear_stock']) ? $_POST['clear_stock'] : '0';
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddssssisiiisssssssssssssssssiiiisiissssi');
