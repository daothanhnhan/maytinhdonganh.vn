        ...
        <ul class="listMenuFL">
          ...
          <!--  <li><a href="index.php?page=danh-muc-dich-vu" title=""
           ...
           <li><a href="index.php?page=dich-vu" title=""
            ...
            <li><a href="index.php?page=thuong-hoi" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Thường hỏi</a>
            </li>
            ...
            <li><a href="index.php?page=mua-tra-gop" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Mua trả góp</a>
            </li>

            <li><a href="index.php?page=import" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Import sản phẩm</a>
            </li>

            <li><a href="index.php?page=xoa-all-san-pham" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Xóa hết sản phẩm</a>
            </li>

            <li><a href="index.php?page=import-code-sale" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Import mã khuyến mãi</a>
            </li>

            <li><a href="index.php?page=xoa-all-ma-khuyen-mai" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Xóa hết mã khuyến mãi</a>
            </li>
