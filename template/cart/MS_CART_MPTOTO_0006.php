...
<div class="uni-checkout-body">
    ...
    <div class="container" onmousemove="price_sale_1()">
                                        ...
                                        <div class="vk-checkout-billing-left">
                                            <div class="col-md-6">
                                                <ul class="nav nav-tabs">
                                                  <li class="active"><a data-toggle="tab" href="#home">Thanh toán Offline</a></li>
                                                  <li><a data-toggle="tab" href="#menu1">Thanh toán Online</a></li>
                                                  ...
                                                  <div id="home" class="tab-pane fade in active">
                                                    <div class="woocommerce-billing-fields">
                                                        ...
                                                        <div class="woocommerce-billing-fields__field-wrapper">
                                                            ...
                                                            <p class="form-row form-row-last">
                                                                <label class="">Nhập mã khuyến mãi <abbr class="required" title="required"></abbr></label>
                                                                <input type="text" class="input-text" name="sale" id="sale-off" placeholder="Mã khuyến mãi" onkeyup="price_sale(this)" onchange="price_sale(this)" >
                                                            </p>
...
<script>
    function price_sale (data) {
        // alert(data.value);
        var code = data.value;
        var xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("price-sale").innerHTML = this.responseText;
            }
        };
        xhttp.open("GET", "/functions/ajax/price_sale.php?code="+code, true);
        xhttp.send();
    }

    function price_sale_1 () {
        // alert('sale');
        // var code = document.getElementById("price-sale").
        // var xhttp = new XMLHttpRequest();
        // xhttp.onreadystatechange = function() {
        //     if (this.readyState == 4 && this.status == 200) {
        //         document.getElementById("price-sale").innerHTML = this.responseText;
