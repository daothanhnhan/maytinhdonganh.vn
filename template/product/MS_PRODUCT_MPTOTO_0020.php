...
<div class="gb-home-product gb-home-product-relate product-home">
    ...
    <div class="titleCategoryProduct_mptoto" style="margin-top: 100px;">SẢN PHẨM ĐÃ XEM</div>
    ...
    <div class="wrapper-pro clearfix row">
        ...
        <?php
            ...
            foreach ($_SESSION['da_xem'] as $item) {

                $rowLang1 = $action_relative->getProductLangDetail_byId($item,$lang);

                $row1 = $action_relative->getProductDetail_byId($item,$lang); 
