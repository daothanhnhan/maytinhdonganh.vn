...
<div class="gb-product-item-prices_mptoto">
    <p class="gb-prices-news">Giá khuyến mãi: <?= number_format($row1['product_price_sale']) ?> VNĐ</p>
    <p class="gb-prices-old">Giá thị trường: <?= number_format($row1['product_price']) ?> VNĐ</p>
</div>
<?php }else if($row1['product_price'] != 0 && $row1['product_price_sale'] == 0){ ?>
<div class="gb-product-item-prices_mptoto">
	<p class="gb-prices-news">Giá thị trường: <?= number_format($row1['product_price']) ?> VNĐ</p>
</div>
<?php }else{?>
