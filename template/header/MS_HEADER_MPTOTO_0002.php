    ...
    <div class="gb-header_mptoto">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 hidden-sm hidden-xs">
                        ...
                        <div class="gb-header-top_mptoto-left">
                            <?php include DIR_MENU."MS_MENU_MPTOTO_0004.php";?>
        ...
        <div class="wrapper toplogo clearfix">
            ...
            <div class="hottline-b">
                ...
                <p>
                    <a href="tel:<?= $rowConfig['content_home6'] ?>">
                        <span><?= $rowConfig['content_home6'] ?></span>
                        <b>Hà Nội</b>
                    </a>
                </p>
                <!-- <p>
                    <a href="tel:0966599746">
                        <span>maytinhdac@gmail.com</span>
                        <b></b>
                    </a>
                </p> -->
            </div>

            <a href="/check-serial" class="checkserial"></a>

        </div>
</div>
        <!-- <div class="gb-header_mptoto-sticky">
        ...
        <div class="gb-header_mptoto-bottom">
            ...
            <div class="container">
                ...
                <div class="gb-header_mptoto-menu">
                    ...
                    <?php include DIR_MENU."MS_MENU_MPTOTO_0005.php";?>
